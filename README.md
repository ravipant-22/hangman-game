...
class HangmanGame:
  def __init__(self, master):
      ...
      self.word_list = ["APPLE","BANANA","MANGO","STRAWBERRY","ORANGE","GRAPE","PINEAPPLE","APRICOT","LEMON","COCONUT","WATERMELON","CHERRY","PAPAYA","BERRY","PEACH","LYCHEE","MUSKMELON"]
  ...
  def initialize_gui(self):
      ...
      self.hangman_canvas = tk.Canvas(self.master, width=300, height=300, bg="light blue")
      self.hangman_canvas.pack(pady=20)
      self.word_display = tk.Label(self.master, text="_ " * len(self.secret_word), font=("Helvetica", 30), bg='pink')
